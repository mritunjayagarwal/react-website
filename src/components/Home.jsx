    ...
    return (
        <>
            ...
            <div className="home3" id = "about">
                <div>
                    <h1>Who we are?</h1>
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quia ipsam veritatis quibusdam voluptates dolore soluta, nobis distinctio deserunt beatae dolorum, facere vero mollitia exercitationem, velit magni aspernatur id voluptatum perspiciatis.</p>
                </div>
            </div>
